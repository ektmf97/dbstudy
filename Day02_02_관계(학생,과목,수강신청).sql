/*
    ...
    2. 두 테이브을 다대다 관계로 직접 연결하는 것은 불가능하다.
...
CREATE TABLE ENROLL_TBL(
    ...
    STU_NO VARCHAR2(5 BYTE) NOT NULL,
    STJ_CODE VARCHAR2(1 BYTE) NOT NULL,
    CONSTRAINT PK_ENROLL PRIMARY KEY(ENR_NO),
    CONSTRAINT FK_ENPOLL_STUDENT FOREIGN KEY(STU_NO) REFERENCES STUDENT_TBL(STU_NO) ON DELETE CASCADE,
    CONSTRAINT FK_ENPOLL_SUBJECT FOREIGN KEY(STJ_CODE) REFERENCES SUBJECT_TBL(STJ_CODE) ON DELETE CASCADE
);
