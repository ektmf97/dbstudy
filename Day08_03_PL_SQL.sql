...
-- EMPLOYEE_ID가 150인 사원의 SALARY가 15000이상이면 '고액연봉', 아니면 '보통연봉을 출력하시오.
DECLARE
...
-- 사원번호가 100 ~ 200인 사원들의 FIRST_NAME, LAST_NAME을 조회하시오.
DECLARE
    EMP_ID EMPLOYEES.EMPLOYEE_ID%TYPE;
    FNAME EMPLOYEES.FIRST_NAME%TYPE;
    LNAME EMPLOYEES.LAST_NAME%TYPE;
...
DECLARE
     EMP_ID EMPLOYEES.EMPLOYEE_ID%TYPE; -- 참조변수
