-- 테이블의 구조 파악
DESCRIBE EMPLOYEES; -- DESC까지 줄여서 사용가능
...
SELECT EMPLOYEE_ID, FIRST_NAME , LAST_NAME, SALARY
  FROM EMPLOYEES
 WHERE SALARY BETWEEN 100000 AND 20000;
...
SELECT EMPLOYEE_ID, FIRST_NAME , LAST_NAME, PHONE_NUMBER
  FROM EMPLOYEES
 WHERE PHONE_NUMBER LIKE '515%'; -- PHONT_NUMBER NOT LIKE '515%'
...
-- 9. EMPLOYEES 테이블에서 높은 SALARY(내림차순 : Descending Sort)를 받는 사원순으로 조회하기
SELECT EMPLOYEE_ID, FIRST_NAME , LAST_NAME, SALARY
  FROM EMPLOYEES
...
SELECT EMPLOYEE_ID, FIRST_NAME , LAST_NAME, DEPARTMENT_ID,SALARY
  FROM EMPLOYEES
 ORDER BY DEPARTMENT_ID ASC, SALARY DESC; -- 두 개의 조건이 주어 졌을때 ,로 구분하기