...
SELECT 
     ...
     , TO_CHAR(1234, '9,999') -- '1,234'           // 천단위구분
     , TO_CHAR(12345, '9,999') -- ###### (5자리 12345를 4자리 형식 9,999에 맞출 수 없습니다.)
...
SELECT 
      TO_DATE('05/06/07', 'YY/MM/DD') -- 2005년6월7일
    , TO_DATE('05/06/07', 'MM/DD/YY') -- 2007년5월6일
  FROM
       DUAL;
       
-- EMPLOYEES 테이블에서 2000/01/01 ~ 2005/12/31 사이에 입사한 사원 조회하기 년/월/일 순서
...
SELECT 
    ...
    , TO_DATE(DT1, 'YYYY-MM-DD') -- 원하는 형식이 적용됨
  FROM
      SAMPLE_TBL;